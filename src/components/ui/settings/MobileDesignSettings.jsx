...
export default function MobileDesignSettings() {
  return (
    <div className="space-y-5 ">
      ...
      <section className="bg-white p-8 rounded-xl space-y-8">
        <h2 className="text-sm md:text-xl font-semibold">Choose a plan</h2>

        {/* Grid layout for plans */}
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6 md:gap-6 lg:gap-8">
          <div className="w-full p-4 bg-blue-lavenda border border-gray-200 rounded-2xl shadow-md sm:p-6 md:p-8 flex flex-col justify-between">
            {/* Header + Features */}
            <div>
              <h3 className="font-semibold text-lg md:text-xl">Basic</h3>
              <p className="mt-1">
              ...
              <ul className="mt-4 mb-6 space-y-3">
                {[
                  ...
                  <li key={i} className="flex items-center gap-2">
                    <IoMdCheckmark className="text-softLight-blue w-5 h-5 flex-shrink-0" />
            ...
            <div className="mt-auto">
              <button className="bg-blue w-full text-white text-sm md:text-base p-2 md:py-4 md:px-4 rounded-xl hover:bg-blue/90 transition cursor-pointer">
          ...
          <div className="bg-task-green w-full  p-4   border-gray-200 rounded-2xl shadow-md sm:p-6 md:p-8 flex flex-col justify-between ">
            ...
            <ul className="mt-4 mb-6 space-y-3 ">
              {[
                ...
                <li key={i} className="flex items-center gap-2">
                  <IoMdJet className="text-bright-cyan w-5 h-5 flex-shrink-0" />
                  <p className="text-sm md:text-lg">{feature}</p>
                </li>
              ))}
            </ul>
            ...
            <div className=" mt-auto">
              <button className="bg-vibrant-cyan-blue  p-2 md:py-4 md:px-4   hover:bg-bright-cyan transition  w-full text-white text-sm md:text-base  rounded-xl  cursor-pointer">
            ...
            <ul className="space-y-2 flex-1 mt-4">
              {[
                ...
                <li key={i} className="flex items-center gap-2">
                  ...
                  <p className="text-xs md:text-lg">{feature}</p>
                </li>
              ))}
            </ul>

            <div className="mt-auto">
              <button className="bg-burnt-orange mt-6 p-2 md:py-4 md:px-4 rounded-lg text-white text-sm w-full  hover:bg-burnt-orange/90 transition  md:text-base cursor-pointer">
